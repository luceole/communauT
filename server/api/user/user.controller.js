...
exports.demandes = function(req, res) {
  User.find({isdemande: true }, '-salt -hashedPassword', function (err, users) {
...
exports.bymail = function(req, res) {
  ...
  User.findOne({ email: mel }, '-salt -hashedPassword', function(err, user) { // don't ever give out the password or salt
...
var clientLdap=ldap.createClient({url:'ldap://172.26.60.27'});
